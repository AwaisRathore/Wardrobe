                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Write your new password below.</p>
                                ...
                                <div class="p-2">
                                    <form action="" method="post">
                                        <div class="mb-3">
                                            <label class="form-label" for="Passwordt">Password</label>
                                            <div class="position-relative auth-pass-inputgroup">
                                                <input type="password" class="form-control pe-5 password-input" onpaste="return false" placeholder="Enter password" name="Password" id="Password" required>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" class="form-control pe-5 password-input" onpaste="return false" placeholder="Confirm password" name="confirmPassword" id="confirmPassword" required>
                                                <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted password-addon" type="button" id="confirmPasswordAdd"><i class="ri-eye-fill align-middle"></i></button>
                                            </div>
                                        </div>
